...
import {
  ...
  CheckCircle2, User, Navigation, Menu, Sparkles, Share2
} from 'lucide-react';
    ...
    >
      ...
      <div className="px-6 py-4 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2 border border-gray-200">
              ...
              <span className="font-bold text-gray-800 text-base">{points}</span>
            </div>
            <button
              onClick={() => setShowMenu(!showMenu)}
              className="p-2 bg-gray-100 rounded-full border border-gray-200 hover:bg-gray-200 transition-all text-gray-600"
            >
              <Menu size={22} />
            </button>
          </div>
          ...
          <button
            ...
            className="p-3 bg-white shadow-lg border border-gray-100 rounded-full text-pink-500 hover:scale-105 transition-transform"
          >
        ...
        <div className="text-center">
          <h1 className="text-2xl font-black text-gray-800 tracking-tight">המסך החברתי</h1>
        </div>
      </div>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-3 mb-3">
                  ...
                  <div className="space-y-2">
                    {leaderboard.map((user, index) => (
                      <div key={index} className={`flex items-center gap-3 p-3 rounded-xl ${user.position === 1 ? 'bg-gradient-to-r from-yellow-400 to-orange-400 text-white' :
        ...
        {showTutorial && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-[#FFF0F3] rounded-3xl p-6 w-[90%] max-w-sm max-h-[85vh] overflow-y-auto shadow-2xl relative border border-white/50"
            >
              <button
